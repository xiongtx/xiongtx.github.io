...
Since the release of ChatGPT, the tech industry has been [abuzz](https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/the-economic-potential-of-generative-ai-the-next-productivity-frontier) with claims of massive productivity gains from AI. Consultants project [trillions](https://www.goldmansachs.com/insights/articles/generative-ai-could-raise-global-gdp-by-7-percent) in economic value, and vendors promise tools that will make workers [10x more effective](https://www.windowscentral.com/software-apps/sam-altman-ai-will-make-coders-10x-more-productive-not-replace-them). Following up on an earlier post about [whether AI will replace programmers]({% post_url 2025-08-21-will-ai-replace-programmers %}), we take a closer look at the fundamental constraints of AI's impact on productivity, and how these constraints might shape the way we work with future AI systems.
...
Where \\( S \\) is the overall speedup, \\( p \\) is the proportion of work that can be accelerated, and \\( s \\) is the speedup factor for that portion. Even if \\( s \rightarrow \infty \\), the overall speedup is bounded by \\( \frac{1}{1 - p} \\).
...
The theoretical constraints of Amdahl's law find empirical support in how AI productivity narratives have evolved. Early claims suggested that AI would democratize programming--that access to AI tools would level the playing field by compensating for lack of experience. GitHub Copilot launched in June 2022 with reports that developers completed tasks [55% faster](https://www.technologyreview.com/2023/12/06/1084457/ai-assistants-copilot-changing-code-software-development-github-openai/), fueling optimism that the barrier to entry for programming would collapse.
