...
After using WordPress to host my blog and [[http://www.tianxiangxiong.com][homepage]] for several years, I've come to the conclusion that WordPress is not the appropriate platform for me.
...
Therefore, I've decided to migrate my blog over to [[https://pages.github.com/][GitHub Pages]] using [[http://jekyllrb.com/][Jekyll]].
